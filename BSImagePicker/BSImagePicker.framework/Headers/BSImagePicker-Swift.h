...
SWIFT_PROTOCOL_NAMED("ImagePickerControllerDelegate")
@protocol ImagePickerControllerDelegate
/// An asset was selected
/// \param imagePicker The image picker that asset was selected in
///
...
/// \param imagePicker The image picker that asset was deselected in
///
/// \param asset deselected asset
///
...
/// \param imagePicker The image picker that assets where selected in
///
...
/// \param imagePicker The image picker that asset was selected in
///
/// \param assets Assets selected when user canceled
///
...
/// \param imagePicker The image picker that selection limit was reached in.
///
/// \param count Number of selected assets.
///
- (void)imagePicker:(ImagePickerController * _Nonnull)imagePicker didReachSelectionLimit:(NSInteger)count;
@end


@interface ImagePickerController (SWIFT_EXTENSION(BSImagePicker)) <ImagePickerControllerDelegate>
- (void)imagePicker:(ImagePickerController * _Nonnull)imagePicker didSelectAsset:(PHAsset * _Nonnull)asset;
- (void)imagePicker:(ImagePickerController * _Nonnull)imagePicker didDeselectAsset:(PHAsset * _Nonnull)asset;
- (void)imagePicker:(ImagePickerController * _Nonnull)imagePicker didFinishWithAssets:(NSArray<PHAsset *> * _Nonnull)assets;
- (void)imagePicker:(ImagePickerController * _Nonnull)imagePicker didCancelWithAssets:(NSArray<PHAsset *> * _Nonnull)assets;
...
@property (nonatomic, copy) NSDictionary<NSAttributedStringKey, id> * _Nonnull previewTitleAttributes;
@property (nonatomic, copy) NSDictionary<NSAttributedStringKey, id> * _Nonnull previewSubtitleAttributes;
@property (nonatomic, copy) NSDictionary<NSAttributedStringKey, id> * _Nonnull albumTitleAttributes;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM(NSInteger, SelectionStyle, closed) {
  SelectionStyleChecked = 0,
  SelectionStyleNumbered = 1,
};
